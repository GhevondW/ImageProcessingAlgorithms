...
namespace
{
	const std::string input_path1 = "Files/MinFilter/i1.bmp";
	const std::string input_path3 = "Files/MinFilter/i2.png";

	const std::string output_path1 = "Files/MinFilter/Result1.bmp";
	const std::string output_path3 = "Files/MinFilter/Result2.png";
